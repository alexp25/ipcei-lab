...
9. Ensure all identifiers used in the code are either defined in the active root file, standard C headers, included MCUXpresso SDK headers, or confirmed generated project headers.
10. Do not leave placeholder functions, TODOs, pseudocode, markdown, or unexplained stubs in the C file.
